...
//            $this->registerFactories($name);
    ...
    protected function registerCommands(string $module):void {
        if ($commands = $this->prepareComponent($module,'commands','index.php')) {
            $this->commands(include $commands);
        }
        if ($commands = $this->prepareComponent($module,'routes','console.php')) {
            include $commands;
        }
    }
